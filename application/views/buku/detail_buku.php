      ...
      <div class="row">
            <div class="col-sm-3 col-md-3">
                <div class="thumbnail" style="height: auto; position: relative; left: 100%; width: 200%;">
                    ...
                    <p>
                       <a class="btn btn-outline-primary fas faw fa-shopping-cart" href="<?= base_url('booking/tambahbooking/' . $id); ?>">Booking</a>
                       <span class="btn btn-outline-secondary fas fw fa-reply" onclick="window.hostory.go(-1)">Kembali</span>
                   </p>
             </div>
          </div>
       </div>
